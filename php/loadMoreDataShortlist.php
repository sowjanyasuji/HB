...
$lst_id=$_POST['lastId'];
// echo $rec_id;
$sql = "select * from resume_status inner join r_jobpost on resume_status.cv_jb_id=r_jobpost.j_id inner join c_log on c_log.cl_id=resume_status.cv_can_id inner join basic_info on basic_info.b_uid=resume_status.cv_can_id inner join edu_qf on edu_qf.e_uid=resume_status.cv_can_id where r_jobpost.r_id='$rec_id' and `cv_shortlisted`='1' and resume_status.cv_jb_id='$job_id' and resume_status.cv_id > '$lst_id' order by resume_status.cv_id limit 1";
// echo $sql;
