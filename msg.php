                ...
                <div class="col-md-7">
                  ...
                  <div class="tab-content scrollbar-wrapper wrapper scrollbar-outer">
                    ...
                    <div class="tab-pane active" id="contact-<?php echo $mfet['msg_sid'] ?>">
									...
									<?php	} ?>
                      <div class="chat-body">
												<!-- <input type="hidden" value="<?php //echo $mfet['msg_sid']; ?>" name="rid" /> -->
                      	...
                      	<ul class="chat-message">
                              ...
                              <div class="chat-item-header">
                              	...
                              	<small class="text-muted"><?php echo $msg_bfet['msg_sdt'] ?></small>
														  ...
														  <!-- <input type="hidden" value="<?php echo $msgid ?>" name="rid" /> -->
                              ...
                              <p><?php echo $msg_bfet['msf_desc'] ?></p>
											...
											<!-- <form class="form form-conrol" action="" method="post">
...
<form class="form form-contol" action="" method="post">
                  <div class="send-message">
                    <div class="input-group">
