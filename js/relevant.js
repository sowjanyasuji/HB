...
'<div class="post-detail">'+
  '<div class="user-info">'+
      '<h4  style="text-transfrom:capitalize;margin:0px"><a href="#" class="profile-link follow_rec" id="'+rec_det[j].r_compname+'" name="'+rec_det[j].r_id+'">'+rec_det[j].r_compname+'</a> </h4>'+
